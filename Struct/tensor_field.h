...
namespace zgCFD {
    ...
    class TensorField :
        public BaseField <Tensor<Scalar>, vol_or_surface>
    {
    public:
        //构造函数

        TensorField(const std::string& field_name, const std::string& field_path, const std::string& is_write = "no", const std::string& is_read = "no");
        TensorField(const Mesh& mesh, const std::string& field_name, const std::string& field_path, const std::string& is_write = "no", const std::string& is_read = "no");
        TensorField(const Tensor<Scalar>& value, const Mesh& mesh, const std::string& field_name, const std::string& field_path, const std::string& is_write = "no", const std::string& is_read = "no");
        TensorField(const TensorField& field, const std::string& field_name, const std::string& field_path, const std::string& is_write = "no", const std::string& is_read = "no");
...
#include "tensor_fieldl.h"
	template<int vol_or_surface>
	TensorField<vol_or_surface>::TensorField(const std::string& field_name, const std::string& field_path, const std::string& is_write, const std::string& is_read) {
	...
	template<int vol_or_surface>
	TensorField<vol_or_surface>::TensorField(const Mesh& mesh, const std::string& field_name, const std::string& field_path, const std::string& is_write, const std::string& is_read) {

		//vol_or_surface == 0表示体积场；vol_or_surface == 1表示面积场
		if (vol_or_surface == 0) {
			this->value_.resize(mesh.elements_.size(), Tensor<Scalar>(0, 0, 0, 0, 0, 0, 0, 0, 0));
		}
		else {
	...
	template<int vol_or_surface>
	TensorField<vol_or_surface>::TensorField(const Tensor<Scalar>& value, const Mesh& mesh, const std::string& field_name, const std::string& field_path, const std::string& is_write, const std::string& is_read) {
	...
	template<int vol_or_surface>
	TensorField<vol_or_surface>::TensorField(const TensorField<vol_or_surface>& field, const std::string& field_name, const std::string& field_path, const std::string& is_write, const std::string& is_read) {
